...
<script runat="server">
	...
	public override void SetConfig()
	{
		...
		PluginSettings.Add("ImageResize_smallThumb", "240x240" );
		PluginSettings.Add("ImageResize_mediumThumb", "480x480" );
		PluginSettings.Add("ImageResize_largeThumb", "680x680" );
		...
		PluginSettings.Add("Watermark_transparency", "100" );
