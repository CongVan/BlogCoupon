...
(function () {
    ...
    (function () {
        function a(a, b, c, d, e) {
            ...
            } function f(a) { var b, c, d, e, l = {}, t = 1; for (a = B(a); b = a.match(p);)(c = b[2]) ? (d = C(c, "styles"), e = C(c, "attrs"), c = C(c, "classes")) : d = e = c = null, l["$" + t++] = { elements: b[1], classes: c, styles: d, attributes: e }, a = a.slice(b[0].length); return l } function C(a, b) { var c = a.match(F[b]); return c ? B(c[1]) : null } function w(a) {
                ...
                G = /^(object|embed|param)$/, N; N = CKEDITOR.filter.transformationsTools = {
                    sizeToStyle: function (a) { this.lengthToStyle(a, "width"); this.lengthToStyle(a, "height") }, sizeToAttribute: function (a) { this.lengthToAttribute(a, "width"); this.lengthToAttribute(a, "height") }, lengthToStyle: function (a, b, c) { c = c || b; if (!(c in a.styles)) { var d = a.attributes[b]; d && (/^\d+$/.test(d) && (d += "px"), a.styles[c] = d) } delete a.attributes[b] }, lengthToAttribute: function (a, b, c) {
                        ...
                        if ("string" == typeof b) a.name = b; else {
                            var c = b.getDefinition(), d = c.styles, e = c.attributes, l, t, f, v; a.name = c.element; for (l in e) if ("class" == l) for (c =
                                ...
                                a.document =
                                    ...
                                    a.blockless && CKEDITOR.env.ie && CKEDITOR.env.needsBrFiller && this.attachListener(this, "keyup", function (b) { b.data.getKeystroke() in z && !this.getFirst(c) && (this.appendBogus(), b = a.createRange(), b.moveToPosition(this, CKEDITOR.POSITION_AFTER_START), b.select()) }); this.attachListener(this, "dblclick", function (b) { if (a.readOnly) return !1; b = { element: b.data.getTarget() }; a.fire("doubleclick", b) }); CKEDITOR.env.ie && this.attachListener(this, "click", b); CKEDITOR.env.ie && !CKEDITOR.env.edge || this.attachListener(this, "mousedown",
                                        function (b) { var c = b.data.getTarget(); c.is("img", "hr", "input", "textarea", "select") && !c.isReadOnly() && (a.getSelection().selectElement(c), c.is("input", "textarea", "select") && b.data.preventDefault()) }); CKEDITOR.env.edge && this.attachListener(this, "mouseup", function (b) { (b = b.data.getTarget()) && b.is("img") && a.getSelection().selectElement(b) }); CKEDITOR.env.gecko && this.attachListener(this, "mouseup", function (b) {
                                            ...
                                            if (a.readOnly) return !0; var c = b.data.domEvent.getKey(); if (c in z && (b = a.getSelection(), 0 !== b.getRanges().length)) {
                ...
                var a = x ? function () {
                    function a(b) { return (new CKEDITOR.dom.node(b)).getIndex() } var b = function (b, c) {
                        b = b.duplicate(); b.collapse(c); var d = b.parentElement(); if (!d.hasChildNodes()) return { container: d, offset: 0 }; for (var e = d.children, f, g, h = b.duplicate(), k = 0,
                            l = e.length - 1, r = -1, q, n; k <= l;)if (r = Math.floor((k + l) / 2), f = e[r], h.moveToElementText(f), q = h.compareEndPoints("StartToStart", b), 0 < q) l = r - 1; else if (0 > q) k = r + 1; else return { container: d, offset: a(f) }; if (-1 == r || r == e.length - 1 && 0 > q) {
...
*/
    ...
    (function () {
        ...
        requires: "panelbutton,floatpanel", init: function (f) {
            function t(a, e, g, h, m) {
                var n = new CKEDITOR.style(l["colorButton_" + e + "Style"]), q = CKEDITOR.tools.getNextId() + "_colorBox", p; m = m || {}; f.ui.add(a, CKEDITOR.UI_PANELBUTTON, {
                    label: g, title: g, modes: { wysiwyg: 1 }, editorFocus: 0, toolbar: "colors," + h, allowedContent: n, requiredContent: n, contentTransformations: m.contentTransformations, panel: { css: CKEDITOR.skin.getPath("editor"), attributes: { role: "listbox", "aria-label": k.panelTitle } }, onBlock: function (a,
                        b) { p = b; b.autoSize = !0; b.element.addClass("cke_colorblock"); b.element.setHtml(y(a, e, q)); b.element.getDocument().getBody().setStyle("overflow", "hidden"); CKEDITOR.ui.fire("ready", this); var c = b.keys, d = "rtl" == f.lang.dir; c[d ? 37 : 39] = "next"; c[40] = "next"; c[9] = "next"; c[d ? 39 : 37] = "prev"; c[38] = "prev"; c[CKEDITOR.SHIFT + 9] = "prev"; c[32] = "click" }, refresh: function () { f.activeFilter.check(n) || this.setState(CKEDITOR.TRISTATE_DISABLED) }, onOpen: function () {
                            var a = f.getSelection(), b = a && a.getStartElement(), c = f.elementPath(b);
                            if (c) {
                                b = c.block || c.blockLimit || f.document.getBody(); do c = b && b.getComputedStyle("back" == e ? "background-color" : "color") || "transparent"; while ("back" == e && "transparent" == c && b && (b = b.getParent())); c && "transparent" != c || (c = "#ffffff"); !1 !== l.colorButton_enableAutomatic && this._.panel._.iframe.getFrameDocument().getById(q).setStyle("background-color", c); if (b = a && a.getRanges()[0]) {
                                    for (var a = new CKEDITOR.dom.walker(b), d = b.collapsed ? b.startContainer : a.next(), b = ""; d;) {
                                    d.type === CKEDITOR.NODE_TEXT && (d = d.getParent());
                                        d = u(d.getComputedStyle("back" == e ? "background-color" : "color")); b = b || d; if (b !== d) { b = ""; break } d = a.next()
                                    } a = b; b = p._.getItems(); for (d = 0; d < b.count(); d++) { var g = b.getItem(d); g.removeAttribute("aria-selected"); a && a == u(g.getAttribute("data-value")) && g.setAttribute("aria-selected", !0) }
                                } return c
                            }
                        }
                })
            } function y(a, e, g) {
                var h = [], m = l.colorButton_colors.split(","), n = l.colorButton_colorsPerRow || 6, q = f.plugins.colordialog && !1 !== l.colorButton_enableMore, p = m.length + (q ? 2 : 1), r = CKEDITOR.tools.addFunction(function z(b, c) {
                    function d(a) {
                        this.removeListener("ok",
                            d); this.removeListener("cancel", d); "ok" == a.name && z(this.getContentElement("picker", "selectedColor").getValue(), c)
                    } if ("?" == b) f.openDialog("colordialog", function () { this.on("ok", d); this.on("cancel", d) }); else {
                        f.focus(); a.hide(); f.fire("saveSnapshot"); f.removeStyle(new CKEDITOR.style(l["colorButton_" + c + "Style"], { color: "inherit" })); if (b) {
                            var e = l["colorButton_" + c + "Style"]; e.childRule = "back" == c ? function (a) { return v(a) } : function (a) { return !(a.is("a") || a.getElementsByTag("a").count()) || v(a) }; f.applyStyle(new CKEDITOR.style(e,
                                { color: b }))
                        } f.fire("saveSnapshot")
                    }
                }); !1 !== l.colorButton_enableAutomatic && h.push('\x3ca class\x3d"cke_colorauto" _cke_focus\x3d1 hidefocus\x3dtrue title\x3d"', k.auto, '" onclick\x3d"CKEDITOR.tools.callFunction(', r, ",null,'", e, "');return false;\" href\x3d\"javascript:void('", k.auto, '\')" role\x3d"option" aria-posinset\x3d"1" aria-setsize\x3d"', p, '"\x3e\x3ctable role\x3d"presentation" cellspacing\x3d0 cellpadding\x3d0 width\x3d"100%"\x3e\x3ctr\x3e\x3ctd colspan\x3d"' + n + '" align\x3d"center"\x3e\x3cspan class\x3d"cke_colorbox" id\x3d"',
                    g, '"\x3e\x3c/span\x3e', k.auto, "\x3c/td\x3e\x3c/tr\x3e\x3c/table\x3e\x3c/a\x3e"); h.push('\x3ctable role\x3d"presentation" cellspacing\x3d0 cellpadding\x3d0 width\x3d"100%"\x3e'); for (g = 0; g < m.length; g++) {
                    0 === g % n && h.push("\x3c/tr\x3e\x3ctr\x3e"); var b = m[g].split("/"), c = b[0], d = b[1] || c; b[1] || (c = "#" + c.replace(/^(.)(.)(.)$/, "$1$1$2$2$3$3")); b = f.lang.colorbutton.colors[d] || d; h.push('\x3ctd\x3e\x3ca class\x3d"cke_colorbox" _cke_focus\x3d1 hidefocus\x3dtrue title\x3d"', b, '" onclick\x3d"CKEDITOR.tools.callFunction(',
                        r, ",'", c, "','", e, "'); return false;\" href\x3d\"javascript:void('", b, '\')" data-value\x3d"' + d + '" role\x3d"option" aria-posinset\x3d"', g + 2, '" aria-setsize\x3d"', p, '"\x3e\x3cspan class\x3d"cke_colorbox" style\x3d"background-color:#', d, '"\x3e\x3c/span\x3e\x3c/a\x3e\x3c/td\x3e')
                    } q && h.push('\x3c/tr\x3e\x3ctr\x3e\x3ctd colspan\x3d"' + n + '" align\x3d"center"\x3e\x3ca class\x3d"cke_colormore" _cke_focus\x3d1 hidefocus\x3dtrue title\x3d"', k.more, '" onclick\x3d"CKEDITOR.tools.callFunction(', r, ",'?','", e, "');return false;\" href\x3d\"javascript:void('",
                        k.more, "')\"", ' role\x3d"option" aria-posinset\x3d"', p, '" aria-setsize\x3d"', p, '"\x3e', k.more, "\x3c/a\x3e\x3c/td\x3e"); h.push("\x3c/tr\x3e\x3c/table\x3e"); return h.join("")
            } function v(a) { return "false" == a.getAttribute("contentEditable") || a.getAttribute("data-nostyle") } function u(a) { return CKEDITOR.tools.convertRgbToHex(a || "").replace(/#/, "").toLowerCase() } var l = f.config, k = f.lang.colorbutton; if (!CKEDITOR.env.hc) {
                t("TextColor", "fore", k.textColorTitle, 10, {
                    contentTransformations: [[{
                        element: "font", check: "span{color}",
                        left: function (a) { return !!a.attributes.color }, right: function (a) { a.name = "span"; a.attributes.color && (a.styles.color = a.attributes.color); delete a.attributes.color }
                    }]]
                }); var w = {}, x = f.config.colorButton_normalizeBackground; if (void 0 === x || x) w.contentTransformations = [[{
                    element: "span", left: function (a) { var e = CKEDITOR.tools; if ("span" != a.name || !a.styles || !a.styles.background) return !1; a = e.style.parse.background(a.styles.background); return a.color && 1 === e.objectKeys(a).length }, right: function (a) {
                        var e = (new CKEDITOR.style(f.config.colorButton_backStyle,
                            { color: a.styles.background })).getDefinition(); a.name = e.element; a.styles = e.styles; a.attributes = e.attributes || {}; return a
                    }
                }]]; t("BGColor", "back", k.bgColorTitle, 20, w)
            }
        }
    ...
    CKEDITOR.tools.buildTableMap = function (q, t, D, B, w) { q = q.$.rows; D = D || 0; B = "number" === typeof B ? B : q.length - 1; w = "number" === typeof w ? w : -1; var p = -1, m = []; for (t = t || 0; t <= B; t++) { p++; !m[p] && (m[p] = []); for (var v = -1, x = D; x <= (-1 === w ? q[t].cells.length - 1 : w); x++) { var y = q[t].cells[x]; if (!y) break; for (v++; m[p][v];)v++; for (var z = isNaN(y.colSpan) ? 1 : y.colSpan, y = isNaN(y.rowSpan) ? 1 : y.rowSpan, A = 0; A < y && !(t + A > B); A++) { m[p + A] || (m[p + A] = []); for (var F = 0; F < z; F++)m[p + A][v + F] = q[t].cells[x] } v += z - 1; if (-1 !== w && v >= w) break } } return m }; (function () {
        function B(a, b) {
            var c = a.getAscendant("table"), d = b.getAscendant("table"), g = CKEDITOR.tools.buildTableMap(c), e = a.getAscendant("tr", !0).$.rowIndex, f = b.getAscendant("tr", !0).$.rowIndex, n = [], r = {}, p, l; c.contains(d) && (b = b.getAscendant({ td: 1, th: 1 }), f = b.getAscendant("tr", !0).$.rowIndex); e > f && (c = e, e = f, f = c, c = a, a = b, b = c); for (c = 0; c < g[e].length; c++)if (a.$ === g[e][c]) { p = c; break } for (c = 0; c < g[f].length; c++)if (b.$ === g[f][c]) { l = c; break } p > l && (c = p, p = l, l = c); for (c = e; c <= f; c++)for (e = p; e <= l; e++)d = new CKEDITOR.dom.element(g[c][e]),
                d.$ && !d.getCustomData("selected_cell") && (n.push(d), CKEDITOR.dom.element.setMarker(r, d, "selected_cell", !0)); CKEDITOR.dom.element.clearAllMarkers(r); return n
        ...
        } function x(a, b) { var c = [], d, g; for (g = 0; g < b.length; g++)d = a.createRange(), d.setStartBefore(b[g]), d.setEndAfter(b[g]), c.push(d); a.getSelection().selectRanges(c) } function K(a) {
            var b = a.editable().find(".cke_table-faked-selection"); 1 > b.count() ||
                (b = B(b.getItem(0), b.getItem(b.count() - 1)), x(a, b))
        } function L(a, b, c) { var d = t(a.getSelection(!0)); b = b.is("table") ? null : b; var g; (g = h.active && !h.first) && !(g = b) && (g = a.getSelection().getRanges(), g = 1 < d.length || g[0] && !g[0].collapsed ? !0 : !1); if (g) h.first = b || d[0], h.dirty = b ? !1 : 1 !== d.length; else if (h.active && b && h.first.getAscendant("table").equals(b.getAscendant("table"))) { d = B(h.first, b); if (!h.dirty && 1 === d.length) return C(a, "mouseup" === c.name); h.dirty = !0; h.last = b; x(a, d) } } function M(a) {
            var b = (a = a.editor || a.sender.editor) &&
                a.getSelection(), c = b && b.getRanges() || [], d; if (b && (C(a), b.isInTable() && b.isFake)) { 1 === c.length && c[0]._getTableElement() && c[0]._getTableElement().is("table") && (d = c[0]._getTableElement()); d = t(b, d); a.fire("lockSnapshot"); for (b = 0; b < d.length; b++)d[b].addClass("cke_table-faked-selection"); 0 < d.length && (a.editable().addClass("cke_table-faked-selection-editor"), d[0].getAscendant("table").addClass("cke_table-faked-selection-table")); a.fire("unlockSnapshot") }
        } function y(a) {
            function b(a, b) {
                return a && b ? a.equals(b) ||
                    a.contains(b) || b.contains(a) || a.getCommonAncestor(b).is(p) : !1
            } function c(a) { return !a.getAscendant("table", !0) && a.getDocument().equals(g.document) } function d(a, d, e, g) { return "mousedown" === a.name && (D(a) || !g) || "mouseup" === a.name && !c(a.data.getTarget()) && !b(e, g) ? !0 : !1 } if (a.data.getTarget().getName) {
                var g = a.editor || a.listenerData.editor, e = g.getSelection(1), f = J(g), n = a.data.getTarget(), r = n && n.getAscendant({ td: 1, th: 1 }, !0), n = n && n.getAscendant("table", !0), p = { table: 1, thead: 1, tbody: 1, tfoot: 1, tr: 1, td: 1, th: 1 }; d(a,
                    e, f, n) && C(g, !0); !h.active && "mousedown" === a.name && D(a) && n && (h = { active: !0 }, CKEDITOR.document.on("mouseup", y, null, { editor: g })); (r || n) && L(g, r || n, a); "mouseup" === a.name && (D(a) && (c(a.data.getTarget()) || b(f, n)) && K(g), h = { active: !1 }, CKEDITOR.document.removeListener("mouseup", y))
            }
            ...
            function c(a) { a.cancel() } var d = a.getSelection(), g = d.createBookmarks(),
                e = a.document, f = a.createRange(), n = e.getDocumentElement().$, r = CKEDITOR.env.ie && 9 > CKEDITOR.env.version, p = a.blockless || CKEDITOR.env.ie ? "span" : "div", l, m, z, q; e.getById("cke_table_copybin") || (l = e.createElement(p), m = e.createElement(p), m.setAttributes({ id: "cke_table_copybin", "data-cke-temp": "1" }), l.setStyles({ position: "absolute", width: "1px", height: "1px", overflow: "hidden" }), l.setStyle("ltr" == a.config.contentsLangDirection ? "left" : "right", "-5000px"), l.setHtml(a.getSelectedHtml(!0)), a.fire("lockSnapshot"), m.append(l),
                    a.editable().append(m), q = a.on("selectionChange", c, null, null, 0), r && (z = n.scrollTop), f.selectNodeContents(l), f.select(), r && (n.scrollTop = z), setTimeout(function () { m.remove(); d.selectBookmarks(g); q.removeListener(); a.fire("unlockSnapshot"); b && (a.extractSelectedHtml(), a.fire("saveSnapshot")) }, 100))
            ...
            function b(a) {
                a = a.getRanges()[0]; var b = a.endContainer.getAscendant("tr", !0); if (b && a.collapsed) {
                    if (a.checkBoundaryOfElement(b,
                        CKEDITOR.START)) return 1; if (a.checkBoundaryOfElement(b, CKEDITOR.END)) return 2
                } return 0
            ...
            n.setHtml(e.toHtml(a.data.dataValue), { fixForBody: !1 }); m = n.findOne("table"); if (f.getRanges().length && (f.isInTable() || (q = b(f))) && (k = t(f), k.length)) {
                a.stop(); a = k[0].getAscendant("table"); k = t(f, a); h = k[0]; l = h.getParent(); u = k[k.length - 1]; w = u.getParent(); if (!q) for (e = 0; e < k.length; e++)k[e].setHtml(""); if (1 < n.getChildCount() || !m) k[0].setHtml(n.getHtml()), g.fire("saveSnapshot"); else {
                    if (q) {
                        k = l.getChildCount(); l = w = new CKEDITOR.dom.element("tr"); l["insert" + (1 === q ? "Before" : "After")](h.getParent()); for (e = 0; e < k; e++)h =
                            new CKEDITOR.dom.element("td"), h.appendTo(l); h = l.getFirst(); u = l.getLast(); f.selectElement(l); k = t(f)
                        ...
                        l.$.rowIndex, r, w.$.rowIndex, k); for (e = 0; e < f.length; e++)for (p = new CKEDITOR.dom.element(a.$.rows[l.$.rowIndex + e]), k = 0; k < f[e].length; k++)if (v = new CKEDITOR.dom.element(f[e][k]), n = q[e] && q[e][k] ? new CKEDITOR.dom.element(q[e][k]) : null, v && !v.getCustomData("processed")) {
                            if (n && n.getParent()) v.replace(n); else if (0 === k || f[e][k - 1]) (n = 0 !== k ? new CKEDITOR.dom.element(f[e][k - 1]) : null) && p.equals(n.getParent()) ? v.insertAfter(n) : 0 < r ? v.insertAfter(new CKEDITOR.dom.element(p.$.cells[r])) : p.append(v, !0); CKEDITOR.dom.element.setMarker(z,
                                v, "processed", !0)
                        } else v.getCustomData("processed") && n && n.remove(); CKEDITOR.dom.element.clearAllMarkers(z); x(g, B(new CKEDITOR.dom.element(f[0][0]), v)); g.fire("saveSnapshot"); setTimeout(function () { g.fire("afterPaste") }, 0)
                }
            }
        } function F(a, b, c) { a.on("beforeCommandExec", function (d) { -1 !== CKEDITOR.tools.array.indexOf(b, d.data.name) && (d.data.selectedCells = t(a.getSelection())) }); a.on("afterCommandExec", function (d) { -1 !== CKEDITOR.tools.array.indexOf(b, d.data.name) && c(a, d.data) }) } var h = { active: !1 }, A, t, E, H, I;
        CKEDITOR.plugins.tableselection = {
            getCellsBetween: B, keyboardIntegration: function (a) {
                function b(a) { a.getEnclosedNode() ? a.getEnclosedNode().setText("") : a.deleteContents(); CKEDITOR.tools.array.forEach(a._find("td"), function (a) { a.appendBogus() }) } var c = a.editable(); c.attachListener(c, "keydown", function (a) {
                    function c(b, e) {
                        if (!e.length) return null; var g = a.createRange(), l = CKEDITOR.dom.range.mergeRanges(e); CKEDITOR.tools.array.forEach(l, function (a) { a.enlarge(CKEDITOR.ENLARGE_ELEMENT) }); var m = l[0].getBoundaryNodes(),
                            h = m.startNode, m = m.endNode; if (h && h.is && h.is(f)) { for (var q = h.getAscendant("table", !0), k = h.getPreviousSourceNode(!1, CKEDITOR.NODE_ELEMENT, q), t = !1, u = function (a) { return !h.contains(a) && a.is && a.is("td", "th") }; k && !u(k);)k = k.getPreviousSourceNode(!1, CKEDITOR.NODE_ELEMENT, q); !k && m && m.is && !m.is("table") && m.getNext() && (k = m.getNext().findOne("td, th"), t = !0); if (k) g["moveToElementEdit" + (t ? "Start" : "End")](k); else g.setStartBefore(h.getAscendant("table", !0)), g.collapse(!0); l[0].deleteContents(); return [g] } if (h) return g.moveToElementEditablePosition(h),
                                [g]
                    } var e = { 37: 1, 38: 1, 39: 1, 40: 1, 8: 1, 46: 1 }, f = CKEDITOR.tools.extend({ table: 1 }, CKEDITOR.dtd.$tableContent); delete f.td; delete f.th; return function (f) {
                        var h = f.data.getKey(), p, l = 37 === h || 38 == h, m, t, q; if (e[h] && (p = a.getSelection()) && p.isInTable() && p.isFake) if (m = p.getRanges(), t = m[0]._getTableElement(), q = m[m.length - 1]._getTableElement(), f.data.preventDefault(), f.cancel(), 8 < h && 46 > h) m[0].moveToElementEditablePosition(l ? t : q, !l), p.selectRanges([m[0]]); else {
                            for (f = 0; f < m.length; f++)b(m[f]); (f = c(t, m)) ? m = f : m[0].moveToElementEditablePosition(t);
                            p.selectRanges(m); a.fire("saveSnapshot")
                        }
                    }
                }(a), null, null, -1); c.attachListener(c, "keypress", function (d) { var c = a.getSelection(), e = d.data.$.charCode || 13 === d.data.getKey(), f; if (c && c.isInTable() && c.isFake && e && !(d.data.getKeystroke() & CKEDITOR.CTRL)) { d = c.getRanges(); e = d[0].getEnclosedNode().getAscendant({ td: 1, th: 1 }, !0); for (f = 0; f < d.length; f++)b(d[f]); d[0].moveToElementEditablePosition(e); c.selectRanges([d[0]]) } }, null, null, -1)
            }, isSupportedEnvironment: !(CKEDITOR.env.ie && 11 > CKEDITOR.env.version)
        }; CKEDITOR.plugins.add("tableselection",
            {
                requires: "clipboard,tabletools", onLoad: function () { A = CKEDITOR.plugins.tabletools; t = A.getSelectedCells; E = A.getCellColIndex; H = A.insertRow; I = A.insertColumn; CKEDITOR.document.appendStyleSheet(this.path + "/styles/tableselection.css") }, init: function (a) {
                    CKEDITOR.plugins.tableselection.isSupportedEnvironment && (a.addContentsCss && a.addContentsCss(this.path + "/styles/tableselection.css"), a.on("contentDom", function () {
                        var b = a.editable(), c = b.isInline() ? b : a.document, d = { editor: a }; b.attachListener(c, "mousedown", y, null,
                        ...
                        x(a,
                            c.selectedCells)
                    }), F(a, ["cellMerge", "cellMergeRight", "cellMergeDown"], function (a, c) { x(a, [c.commandData.cell]) }), F(a, ["cellDelete"], function (a) { C(a, !0) }))
                }
            })
    })(); (function () {
